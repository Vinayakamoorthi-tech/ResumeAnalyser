        ...
        <div style={{
          ...
          <form onSubmit={submit}>
            ...
            <div style={{ marginBottom: "20px" }}>
              ...
              <input type="password" required style={inputStyle} placeholder="••••••••" value={form.password} onChange={e => setForm(f => ({ ...f, password: e.target.value }))} />
            </div>
          ...
          <p style={{ color: theme.textMuted, fontSize: "13px", textAlign: "center", marginTop: "20px", marginBottom: 0 }}>
            ...
            <Link to="/register" style={{ color: theme.primary, textDecoration: "none", fontWeight: 600 }}>Register</Link>
          </p>
        </div>
      </div>
    </div>
