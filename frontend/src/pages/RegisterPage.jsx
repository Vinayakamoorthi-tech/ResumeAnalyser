        ...
        <div style={card}>
          <form onSubmit={submit}>
            <div style={{ marginBottom: "16px" }}>
              <label style={{ color: theme.textSecondary, fontSize: "12px", fontWeight: 700, letterSpacing: "1px", display: "block", marginBottom: "8px" }}>FULL NAME</label>
              <input
          ...
          <p style={{ color: theme.textMuted, fontSize: "13px", textAlign: "center", marginTop: "20px", marginBottom: 0 }}>
            ...
            <Link to="/login" style={{ color: "#93c5fd", textDecoration: "none", fontWeight: 600 }}>Sign in</Link>
          </p>
        </div>
      </div>
    </div>
